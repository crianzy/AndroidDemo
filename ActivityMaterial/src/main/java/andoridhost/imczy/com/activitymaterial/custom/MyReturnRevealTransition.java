 ...
 */
public class MyReturnRevealTransition extends Transition {
    private static final String TAG = "MyReturnRevealTransition";
    ...
    public MyReturnRevealTransition(View animView) {
...
//        startRect.left = transitionValues.view.getLeft();
//        startRect.right = transitionValues.view.getRight();
//        startRect.top = transitionValues.view.getTop();
//        startRect.bottom = transitionValues.view.getBottom();

        transitionValues.view.getGlobalVisibleRect(startRect);

        Log.e(TAG, "captureStartValues:startRect =  " + startRect);
    ...
    private Animator createAnimator(View view, float startRadius, float endRadius) {
        ...
        Log.e(TAG, "createAnimator: view.getWidth() = " + view.getWidth() + " , view.getHeight()  = " + view.getHeight());
