 ...
 */
public class MyRevealTransition extends Transition {
    private static final String TAG = "MyRevealTransition";
    ...
    public MyRevealTransition(View animView) {
...
//        }
        ...
        if (view == animView) {
            Log.e(TAG, "createAnimator: startRadius = " + startRadius + " endRadius = " + endRadius);
