...
public class CommentTopBarReturnTransition extends Transition {

    private static final String TAG = "CommentBottomBarEnterTransition";


    private static final String PROPNAME_TRANSITION_Y = "custom_top_box_return_transition:change_transY:transitionY";
    ...
    public CommentTopBarReturnTransition(View animView, Context context) {
