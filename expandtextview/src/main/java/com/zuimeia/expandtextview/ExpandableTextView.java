...
//        mPosition = position;
//        boolean mIsCollapsed = collapsedStatus.get(position, true);
//        clearAnimation();
//        mCollapsed = mIsCollapsed;
//        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
//        setText(text);
...
//        this.addView(mTv, textLayoutParams);
//        mTv.setEllipsize(TextUtils.TruncateAt.valueOf("END"));
//
//        mButton = new ImageButton(getContext());
//        LayoutParams imgLayoutParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
//        imgLayoutParams.gravity = Gravity.RIGHT | Gravity.BOTTOM;
//        this.addView(mButton, imgLayoutParams);
//
