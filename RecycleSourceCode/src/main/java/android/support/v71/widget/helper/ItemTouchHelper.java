...
package android.support.v71.widget.helper;
...
import android.support.v71.widget.RecyclerView.OnItemTouchListener;
import android.support.v71.widget.RecyclerView.ViewHolder;
import android.view.animation.Interpolator;

import com.czy.recyclesourcecode.R;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    public abstract static class Callback {
        ...
        private static final android.support.v71.widget.helper.ItemTouchUIUtil sUICallback;
        ...
        static {
            if (Build.VERSION.SDK_INT >= 21) {
                sUICallback = new android.support.v71.widget.helper.ItemTouchUIUtilImpl.Lollipop();
            } else if (Build.VERSION.SDK_INT >= 11) {
                sUICallback = new android.support.v71.widget.helper.ItemTouchUIUtilImpl.Honeycomb();
            } else {
                sUICallback = new android.support.v71.widget.helper.ItemTouchUIUtilImpl.Gingerbread();
            }
        }

        /**
         * Returns the {@link android.support.v71.widget.helper.ItemTouchUIUtil} that is used by the {@link Callback} class for visual
         * changes on Views in response to user interactions. {@link android.support.v71.widget.helper.ItemTouchUIUtil} has different
         ...
         * </pre>
         *
         * @return The {@link android.support.v71.widget.helper.ItemTouchUIUtil} instance that is used by the {@link Callback}
         */
        public static android.support.v71.widget.helper.ItemTouchUIUtil getDefaultUIUtil() {
            return sUICallback;
        }
