...
/**
 * A {@link android.support.v71.widget.RecyclerView.LayoutManager} implementations that lays out items in a grid.
 * <p>
...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    @Override
    public int getRowCountForAccessibility(android.support.v71.widget.RecyclerView.Recycler recycler,
    ...
    @Override
    public int getColumnCountForAccessibility(android.support.v71.widget.RecyclerView.Recycler recycler,
                                              android.support.v71.widget.RecyclerView.State state) {
    ...
    @Override
    public void onInitializeAccessibilityNodeInfoForItem(android.support.v71.widget.RecyclerView.Recycler recycler,
                                                         android.support.v71.widget.RecyclerView.State state, View host, AccessibilityNodeInfoCompat info) {
    ...
    @Override
    public void onItemsAdded(android.support.v71.widget.RecyclerView recyclerView, int positionStart, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
    }

    @Override
    public void onItemsChanged(android.support.v71.widget.RecyclerView recyclerView) {
        mSpanSizeLookup.invalidateSpanIndexCache();
    }

    @Override
    public void onItemsRemoved(android.support.v71.widget.RecyclerView recyclerView, int positionStart, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
    }

    @Override
    public void onItemsUpdated(android.support.v71.widget.RecyclerView recyclerView, int positionStart, int itemCount,
                               Object payload) {
        mSpanSizeLookup.invalidateSpanIndexCache();
    }

    @Override
    public void onItemsMoved(android.support.v71.widget.RecyclerView recyclerView, int from, int to, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
    }

    @Override
    public android.support.v71.widget.RecyclerView.LayoutParams generateDefaultLayoutParams() {
        return new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
    }

    @Override
    public android.support.v71.widget.RecyclerView.LayoutParams generateLayoutParams(Context c, AttributeSet attrs) {
        return new LayoutParams(c, attrs);
    }

    @Override
    public android.support.v71.widget.RecyclerView.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
    ...
    @Override
    public boolean checkLayoutParams(android.support.v71.widget.RecyclerView.LayoutParams lp) {
    ...
    private void ensureAnchorIsInFirstSpan(android.support.v71.widget.RecyclerView.Recycler recycler, android.support.v71.widget.RecyclerView.State state,
                                           AnchorInfo anchorInfo) {
    ...
    View findReferenceChild(android.support.v71.widget.RecyclerView.Recycler recycler, android.support.v71.widget.RecyclerView.State state,
        ...
        for (int i = start; i != end; i += diff) {
            ...
            if (position >= 0 && position < itemCount) {
                ...
                if (((android.support.v71.widget.RecyclerView.LayoutParams) view.getLayoutParams()).isItemRemoved()) {
    ...
    private int getSpanGroupIndex(android.support.v71.widget.RecyclerView.Recycler recycler, android.support.v71.widget.RecyclerView.State state,
                                  int viewPosition) {
        if (!state.isPreLayout()) {
    ...
    private int getSpanIndex(android.support.v71.widget.RecyclerView.Recycler recycler, android.support.v71.widget.RecyclerView.State state, int pos) {
        if (!state.isPreLayout()) {
    ...
    private int getSpanSize(android.support.v71.widget.RecyclerView.Recycler recycler, android.support.v71.widget.RecyclerView.State state, int pos) {
        if (!state.isPreLayout()) {
    ...
    private void measureChildWithDecorationsAndMargin(View child, int widthSpec, int heightSpec,
        ...
        android.support.v71.widget.RecyclerView.LayoutParams lp = (android.support.v71.widget.RecyclerView.LayoutParams) child.getLayoutParams();
    ...
    private void assignSpans(android.support.v71.widget.RecyclerView.Recycler recycler, android.support.v71.widget.RecyclerView.State state, int count,
     ...
     */
    public static class LayoutParams extends android.support.v71.widget.RecyclerView.LayoutParams {
        ...
        public LayoutParams(android.support.v71.widget.RecyclerView.LayoutParams source) {
            super(source);
        }
