...
import android.support.v71.widget.RecyclerView.Adapter;
 ...
 * API.
 * <p>
 * It uses {@link android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo} to track the bounds information of the Views. If you would like
 * to
 * extend this class, you can override {@link #obtainHolderInfo()} method to provide your own info
 * class that extends {@link android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo}.
 */
abstract public class
        SimpleItemAnimator extends android.support.v71.widget.RecyclerView.ItemAnimator {
     ...
     * @see android.support.v71.widget.RecyclerView.ItemAnimator#animateDisappearance(ViewHolder, ItemHolderInfo,
     * ItemHolderInfo)
     */
     ...
     * @see android.support.v71.widget.RecyclerView.ItemAnimator#animateDisappearance(ViewHolder, ItemHolderInfo,
     * ItemHolderInfo)
     * @see android.support.v71.widget.RecyclerView.ItemAnimator#animatePersistence(ViewHolder, ItemHolderInfo, ItemHolderInfo)
     * @see android.support.v71.widget.RecyclerView.ItemAnimator#animateAppearance(ViewHolder, ItemHolderInfo, ItemHolderInfo)
     */
