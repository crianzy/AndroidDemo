...
package android.support.v71.util;
...
public class AsyncListUtil<T> {
    ...
    final android.support.v71.util.ThreadUtil.MainThreadCallback<T> mMainThreadProxy;
    final android.support.v71.util.ThreadUtil.BackgroundCallback<T> mBackgroundProxy;
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback,
        ...
        android.support.v71.util.ThreadUtil<T> threadUtil = new MessageThreadUtil<T>();
    ...
    private final android.support.v71.util.ThreadUtil.MainThreadCallback<T>
            mMainThreadCallback = new android.support.v71.util.ThreadUtil.MainThreadCallback<T>() {
        @Override
    ...
    private final android.support.v71.util.ThreadUtil.BackgroundCallback<T>
            mBackgroundCallback = new android.support.v71.util.ThreadUtil.BackgroundCallback<T>() {
