...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T> callback) {
        return new MainThreadCallback<T>() {
            ...
            @Override
            public void addTile(int generation, android.support.v71.util.TileList.Tile<T> tile) {
                    ...
                    while (msg != null) {
                        switch (msg.what) {
                            ...
                            case ADD_TILE:
                                ...
                                callback.addTile(msg.arg1, (android.support.v71.util.TileList.Tile<T>) msg.data);
                                break;
                            case REMOVE_TILE:
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> callback) {
        return new BackgroundCallback<T>() {
            ...
            @Override
            public void recycleTile(android.support.v71.util.TileList.Tile<T> tile) {
                ...
                public void run() {
                    while (true) {
                        ...
                        switch (msg.what) {
                            ...
                            case RECYCLE_TILE:
                                //noinspection unchecked
                                callback.recycleTile((android.support.v71.util.TileList.Tile<T>) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                        }
